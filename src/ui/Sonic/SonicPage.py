...
class SonicPage(PlantillaAirdrop):
    def __init__(self, window):
        ...
        # Añadir opciones específicas de Sonic
        self.add_sonic_settings()
    ...
    def add_sonic_settings(self):
        # Aqu puedes agregar cualquier configuración o widgets específicos para Sonic
    ...
    def add_execution_buttons(self):
        ...
        claim_button = QPushButton("Claim Tokens Arcade")
        apply_button_style(claim_button)  # Apply the common style 
        play_button = QPushButton("Play Arcade Games")
        ...
        # Conectar el botón de Play Arcade Games con la nueva función
    ...
    def button_farm_one(self):
        ...
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "claim", window_settings)
    ...
    def button_farm_two(self):
        ...
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "ArcadeGames", window_settings)
