...
class PhantomWindow(PlantillaAirdrop):
    def __init__(self, window):
        super().__init__(title="Phantom Wallet Creation")
        self.window = window
        ...
        # Añadir opciones específicas de Phantom
    ...
    def add_execution_buttons(self):
        ...
        claim_button = QPushButton("Farm Phantom")
    ...
    def button_farm_one(self):
        ...
        # Llamar a Phantom Script con el archivo Excel
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "Phantom", window_settings)
