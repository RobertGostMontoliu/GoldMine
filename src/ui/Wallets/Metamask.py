...
class MetamaskWindow(PlantillaAirdrop):
    def __init__(self, window):
        super().__init__(title="Metamask Wallet Creation")
        self.window = window
        ...
        # Añadir opciones específicas de Metamask
    ...
    def add_execution_buttons(self):
        ...
        claim_button = QPushButton("Farm Metamask") 
    ...
    def button_farm_one(self):
        ...
        # Llamar a MetamaskScript con el archivo Excel 
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "metamask", window_settings)
