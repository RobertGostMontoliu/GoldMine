...
class RoninWindow(PlantillaAirdrop):
    def __init__(self, window):
        super().__init__(title="Ronin Wallet Creation")
        self.window = window
        ...
        # Añadir opciones específicas de Ronin
    ...
    def add_execution_buttons(self):
        ...
        claim_button = QPushButton("Farm Ronin")
    ...
    def button_farm_one(self):
        ...
        # Llamar a RoninScript con el archivo Excel 
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "Ronin", window_settings)
    ...
    def guardar_directorio_json(self, archivo_excel):
        ...
        json_path = resource_path("ui//JSON_FILE//UrlRoninAccounts.json")
