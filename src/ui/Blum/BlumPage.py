...
class BlumPage(PlantillaAirdrop):
    def __init__(self, window):
        super().__init__(title="Blum Airdrop")
        self.window = window
        ...
        # Añadir opciones específicas de Blum
        self.add_blum_settings()
    ...
    def add_blum_settings(self):
        # Agregar el checkbox para activar o desactivar el BlumClicker
        self.checkbox_blum_clicker = QCheckBox("Play the game")
        self.advanced_layout.addWidget(self.checkbox_blum_clicker)
        
    def is_blum_clicker_activated(self):
        # Retorna el estado del checkbox
        return self.checkbox_blum_clicker.isChecked()
    ...
    def add_execution_button(self):
        ...
        farm_button = QPushButton("Farm Blum")
    ...
    def button_farm(self):
        ...
        # Actualizar el valor del checkbox para Blum Clicker
        window_settings["blum_clicker_activado"] = self.checkbox_blum_clicker.isChecked()

        # Iniciar farmeo
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "blum", window_settings)
