...
class PawnsPage(PlantillaAirdrop):
    def __init__(self, window):
        super().__init__(title="Pawns Airdrop")
        self.window = window
        ...
        # Añadir opciones específicas de Pawns
        self.add_pawns_settings()
    ...
    def add_pawns_settings(self):
        # Agregar el checkbox para activar o desactivar el PawnsClicker
        self.checkbox_pawns_clicker = QCheckBox("Play the game")
        self.advanced_layout.addWidget(self.checkbox_pawns_clicker)
        
    def is_pawns_clicker_activated(self):
        # Retorna el estado del checkbox
        return self.checkbox_pawns_clicker.isChecked()
    ...
    def add_execution_button(self):
        ...
        farm_button = QPushButton("Farm Pawns") 
    ...
    def button_farm(self):
        ...
        # Actualizar el valor del checkbox para Pawns Clicker 
        window_settings["pawns_clicker_activado"] = self.checkbox_pawns_clicker.isChecked()

        # Iniciar farmeo
        self.farming_thread = iniciar_farmeo_multiple(selected_profiles, num_concurrent, "pawns", window_settings) 
